package shop.dear.financial.settlement.application;

import lombok.RequiredArgsConstructor;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import shop.dear.financial.settlement.application.dto.SettlementInfo;
import shop.dear.financial.settlement.application.dto.WalletInfo;
import shop.dear.financial.settlement.application.port.WalletPort;
import shop.dear.financial.settlement.domain.constant.SettlementStatus;
import shop.dear.financial.settlement.domain.model.Settlement;
import shop.dear.financial.settlement.domain.model.SettlementBatch;
import shop.dear.financial.settlement.domain.repository.SettlementBatchRepository;
import shop.dear.financial.settlement.domain.repository.SettlementRepository;
import shop.dear.financial.settlementpolicy.application.SettlementPolicyService;
