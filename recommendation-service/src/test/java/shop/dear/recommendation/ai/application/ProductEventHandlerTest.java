package shop.dear.recommendation.ai.application;

import shop.dear.recommendation.ai.application.EmbeddingService;
import shop.dear.recommendation.ai.application.handler.ProductEventHandler;
...
import shop.dear.recommendation.ai.domain.repository.ProductVectorRepository;
import shop.dear.recommendation.ai.application.port.ProductEmbedder;
import shop.dear.recommendation.ai.application.dto.ProductEvent;
import tools.jackson.databind.json.JsonMapper;
import shop.dear.recommendation.ai.application.port.ProductEventStore;
